...
define('_user_not_registered', "ورود ناموفق است. لطفا مجددا امتحان کنید");
...
define('_btn_library', "کتابخانه");
define('_btn_nutrition', "تغذیه");
define('_btn_education', "آموزش");
define('_btn_logout', "خروج");
define('_btn_signup', "ساخت حساب جدید");

define('_ph_email', "ایمیل");
define('_ph_studentNumber', "شماره دانشجویی");
define('_ph_fieldName', "نام رشته");
...
define('_ph_nationalNumber', "شماره ملی");
define('_ph_phoneNumber', "شماره تلفن");
